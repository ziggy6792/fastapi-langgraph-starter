...
Edit `.env` and fill in your values. The following environment variables are used:

- `PORT` (optional, default: 8001) - Server port
- `HOST` (optional, default: 127.0.0.1) - Server host
- `RELOAD` (optional, default: true) - Enable auto-reload in development
- `OPENAI_API_KEY` (required if using AI endpoints) - Your OpenAI API key
